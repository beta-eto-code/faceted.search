...
class FacetTest extends TestCase
{
    private const FACET_DATA = [
        ...
        'type' => [
            ...
            't-shirt' => ['_3' => 3, '_6' => 6, '_9' => 9],
        ],
        'gender' => [
            'male' => ['_1' => 1, '_6' => 6, '_10' => 10, '_2' => 2],
    ...
    public function testGetFacetResultForCompareRuleList()
    {
        ...
        $this->assertValuePropertyResult($facetResult, 'type', 't-shirt', ['_3' => 3, '_9' => 9]);

        $this->assertValuePropertyResult(
            $facetResult,
            'gender',
            'male',
            ['_1' => 1, '_6' => 6, '_10' => 10, '_2' => 2]
        );
        $this->assertValuePropertyResult(
            $facetResult,
            'gender',
